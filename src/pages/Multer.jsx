...
const Multer = () => {
    ...
    const handleSubmit = async () => {
        ...
        const response = await axios.post('https://jst-chat.onrender.com/api/multer', formData)
    ...
    useEffect(() => {
        ...
        const getImages = async () => {
            const response = await axios.get('https://jst-chat.onrender.com/api/images')
                ...
                {images.map((image,index) => (
                    <Col key={index}>
                        <Card>
                            <Card.Img
                                variant="top"
                                src={`https://jst-chat.onrender.com${image.images[0]}`}
